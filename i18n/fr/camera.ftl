...
virtual-camera-enable = Activer la caméra virtuelle
...
settings-video-encoder = Encodeur vidéo
settings-video-quality = Qualité vidéo
...
exposure-no-controls = Aucun réglage d'exposition disponible
exposure-title = Exposition
exposure-reset = Réinitialiser
...
settings-burst-mode-quality = Algorithme HDR+
...
insights-format-gstreamer = Sortie GStreamer
...
insights-recording-framerate = Fréquence d'images
